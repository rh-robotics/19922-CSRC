...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = KitMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = KitMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = KitMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = KitMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = KitMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = KitMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = KitMecanumDrive.LATERAL_MULTIPLIER;
